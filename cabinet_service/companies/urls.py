...
urlpatterns = [
    path('api/companies/create/', views.api_create_company, name='api_create_company'),
    ...
    path('api/companies/<slug:username>/verification/', views.api_company_verification, name='api_company_verification'),
