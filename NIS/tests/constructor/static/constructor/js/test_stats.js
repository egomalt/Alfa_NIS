/* Страница «Как проходят тест».
 *
 * Показывает автору то, чего не видно из счётчика прохождений: сколько
 * набирают, сколько справляются, сколько бросают на середине и насколько
 * это отличается от среднего по площадке.
 */
(function () {
  'use strict';
