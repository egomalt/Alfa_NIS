/* Формы входа и регистрации: отправка, показ ошибок, состояние кнопки.
 *
 * Ошибки приходят с сервера в двух видах и показываются по-разному:
 *   errors: {поле: [{message}]}  — проблема конкретного поля, текст под полем
 *   message: "..."               — проблема формы целиком (неверная пара логин-пароль,
 *                                  блокировка аккаунта), текст баннером над формой
 */
(() => {
