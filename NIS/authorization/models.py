...
class Account(AbstractBaseUser):
    ...
    def is_active(self):
        ...
        Он должен войти и увидеть в кабинете плашку с причиной и сроком —
        иначе узнать их негде. Действовать ему не даёт core.auth: там
        отклоняется любой запрос заблокированного, кроме чтения.
        """
        return True
